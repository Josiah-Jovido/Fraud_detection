...
#---------------------------------#
st.write("""
# Machine Learning Algorithm App
In this application, the **lazypredict** library is used for building several machine learning models at once.
Programmer: [Josiah Jovido](https://github.com/Josiah-Jovido?tab=repositories)
""")
